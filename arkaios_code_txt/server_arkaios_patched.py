# server_arkaios_patched.py  — sirve arkios-core.html + estáticos y health
...
# Resto de archivos estáticos (worker, imágenes, etc.) los sirve Flask por static_url_path

if __name__ == "__main__":
    port = int(os.getenv("PORT", "5000"))
    print(f"🚀 ARKAIOS static server on http://127.0.0.1:{port}")
