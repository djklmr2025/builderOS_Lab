...
app.listen(process.env.PORT || 8080, '0.0.0.0', () => console.log('ARKAIOS Gateway on :' + (process.env.PORT || 8080))) => console.log('ARKAIOS Gateway on :' + (process.env.PORT || 8080))) => console.log('ARKAIOS Gateway on :' + (process.env.PORT || 8080))) => console.log('ARKAIOS Gateway on :' + (process.env.PORT || 8080))) => {
